...
class SessionBuilder {
    ...
    async initIncoming(record, message) {
        ...
        const preKeyPair = message.preKeyId ? await this.storage.loadPreKey(message.preKeyId) : undefined;
    ...
    async initSession(isInitiator, ourEphemeralKey, ourSignedKey, theirIdentityPubKey,
        ...
        const sharedSecret = new Uint8Array(ourEphemeralKey && theirEphemeralPubKey ? 32 * 5 : 32 * 4);
